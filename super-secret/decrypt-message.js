...
const fileToDecrypt = process.argv[2]; // Get the file to decrypt from the command line. 

// If a file isn't provided, show a message and quit.
if (!fileToDecrypt) {
    console.log("Error: You must specify a file to decrypt.");
    return;
}
